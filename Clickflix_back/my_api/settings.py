...
SECRET_KEY = 'django-insecure-=2^j)-anx863y+jvjm=7zyx11a@=i1%xrp86$)^^h+(0^jd&4o'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        ...
        'rest_framework.permissions.AllowAny', # 인증된 사용자에 대해 모든 view함수를 허용한다
    ],
}
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER' : 'accounts.serializers.CustomProfileSerializer'
}